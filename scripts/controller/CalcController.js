    /**Create Methods | () --> parameters are info that the functions needs
     * attributes --> similar a one variable, however with much more resources
     * encapsulation --> Public | Protected | Private
     *      -- Public --> Without any restraction
     *      -- Protected --> attributes & methods from the same class and Father Class
     *      -- Private --> Only attributes & methods from the same class
    */
